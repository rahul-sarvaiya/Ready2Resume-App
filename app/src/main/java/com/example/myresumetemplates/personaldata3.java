...
public class personaldata3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personaldata3);
                ...
                if (!validateFullName() | !validateAddress() | !validateContact() | !validateEmail() | !validateSummary()) {
                    ...
                    reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            FirebaseDatabase.getInstance().getReference("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("personaldata1")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(personaldata3.this, "Saved Successful", Toast.LENGTH_LONG).show();

                                        openActivity();
                                    } else {
                                        Toast.makeText(personaldata3.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(personaldata3.this, "Something went wrong", Toast.LENGTH_LONG).show();
