...
public class experience3 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Experience1")
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    Toast.makeText(experience3.this,"Saved Successful",Toast.LENGTH_LONG).show();
                                    openActivity();
                                }
                                else{
                                    Toast.makeText(experience3.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(experience3.this,"Something went wrong",Toast.LENGTH_LONG).show();
    ...
    public void openActivity(){
        Intent intent = new Intent(experience3.this, createprofile1.class);
