...
public class skills2 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Skill1")
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    Toast.makeText(skills2.this,"Saved Successful",Toast.LENGTH_LONG).show();
                                }
                                else{
                                    Toast.makeText(skills2.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(skills2.this,"Something went wrong",Toast.LENGTH_LONG).show();
