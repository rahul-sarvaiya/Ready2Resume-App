...
public class education2 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Education1")
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    Toast.makeText(education2.this,"Saved Successful",Toast.LENGTH_LONG).show();
                                    openActivity();
                                }
                                else{
                                    Toast.makeText(education2.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(education2.this,"Something went wrong",Toast.LENGTH_LONG).show();
    ...
    public void openActivity(){
        Intent intent = new Intent(education2.this, createprofile1.class);
