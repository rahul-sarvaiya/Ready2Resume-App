...
public class education4 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Education1")
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    Toast.makeText(education4.this,"Saved Successful",Toast.LENGTH_LONG).show();
                                    openActivity();
                                }
                                else{
                                    Toast.makeText(education4.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(education4.this,"Something went wrong",Toast.LENGTH_LONG).show();
    ...
    public void openActivity(){
        Intent intent = new Intent(education4.this, createprofile1.class);
